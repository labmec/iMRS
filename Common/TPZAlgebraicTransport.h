...
public:
    ...
    struct TCellData{
        ...
        std::vector<std::vector<REAL>> fSaturationEdges;
...
//        std::vector<std::vector<REAL>> fOilfractionalflow;
        ...
        TCellData() : fsim_data(0), fEqNumber(0),fVolume(0), fVolumefactor(0),fMatId(0),fGeoIndex(0),fSaturation(0), fPressure(0), fSaturationLastState(0), fSaturationEdges(0), fDensityOil(0),fdDensityOildp(0), fDensityOilLastState(0),fDensityWater(0), fdDensityWaterdp(0),fDensityWaterLastState(0),fMixedDensity(0), flambda(0), fdlambdawdsw(0),fdlambdaodsw(0),fporosity(0),fKx(0),fKy(0),fKz(0), fWaterfractionalflow(0),fDerivativeWfractionalflow(0),fOilfractionalflow(0), fDerivativeOfractionalflow(0),fCenterCoordinate(0),
        ...
        void SetNumCells(int64_t ncells)
        {
            ...
            fSaturationEdges.resize(ncells);
